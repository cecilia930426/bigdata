function peak_align = sift_my(image)
%% Question 1,2
level = 6;
...
% figure(4)
% subplot(2,2,1)
% imshow(imagePatch{50}, [])
% title('Image patch')  
% subplot(2,2,2)
% imshow(Magnitude{50}, [])
% title('Image gradient magnitude')
% subplot(2,2,3)
% imshow(Magnitude{50}, []); hold on
% [x, y] = meshgrid(1:17, 1:17);
% quiver(x, y,  X{50}', Y{50}');
% title('Image gradient orientation')
% subplot(2,2,4)
% imshow(WeightedMagnitude{50}, [])
